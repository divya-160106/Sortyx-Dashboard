...
var data1 = [
  {
    ...
    delta: { reference: bin1, increasing: { color: "grey" } },
    gauge: {
...
var data2 = [
  {
    ...
    mode: "gauge+number+delta",
    value: bin2,
    title: { text: "Bin Empty", font: { size: 24 } },
    delta: { reference: bin2, increasing: { color: "grey" } },
    gauge: {
      axis: { range: [null, 100], tickwidth: 1, tickcolor: "darkblue" },
      bar: { color: "darkblue" },
      bgcolor: "white",
